        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                @role('Customer')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('customer.transaksi-keluar*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link {{ Route::is('customer.transaksi-masuk*') ? 'active' : '' }}"
                            href="{{ route('customer.transaksi-masuk.index') }}">

                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">

                                <svg xmlns="http://www.w3.org/2000/svg"class="icon icon-tabler icon-tabler-shopping-cart-plus"width="24"height="24" viewBox="0 0 24 24"troke-width="2"stroke="currentColor"fill="none"stroke-linecap="round"stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('customer.prediksi*') ? 'active' : '' }}"
                            href="{{ route('customer.prediksi') }}">
                            ...
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <path d="M15.5 13a3.5 3.5 0 0 0 0 -7"/>
                                    <path d="M8.5 13a3.5 3.5 0 0 1 0 -7"/>
                                    <path d="M12 6a3 3 0 0 1 3 3v6a3 3 0 0 1 -6 0v-6a3 3 0 0 1 3 -3z"/>
                                    <path d="M12 18v3"/>
                                </svg>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('customer.report*') ? 'active' : '' }}"
                ...
                @hasanyrole('Admin|Super Admin')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.prediksi*') ? 'active' : '' }}"
                            href="{{ route('admin.prediksi') }}">
                    ...
                    <div class="hr-text hr-text-left ml-2 mb-2 mt-2">Transaksi</div>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.transaksi-masuk*') ? 'active' : '' }}"
                            href="{{ route('admin.transaksi-masuk.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('admin.transaksi-keluar.index') ? 'active' : '' }}"
                            href="{{ route('admin.transaksi-keluar.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block mr-1">
                                <svg xmlns="http://www.w3.org/2000/svg"
